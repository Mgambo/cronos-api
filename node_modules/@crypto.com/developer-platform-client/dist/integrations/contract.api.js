 ...
 * console.log(abi);
 */
const getContractABI = async (chainId, contractAddress, apiKey) => {
    const url = `${global_constants_js_1.BASE_URL}/api/v1/cdc-developer-platform/contract/${chainId}/contract-abi?contractAddress=${contractAddress}&apiKey=${apiKey}`;
    try {
