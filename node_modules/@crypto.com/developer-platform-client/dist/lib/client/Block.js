...
const block_api_js_1 = require("../../integrations/block.api.js");
...
class Block {
     ...
     * console.log(block);
     */
    static async getBlockByTag(blockTag, txDetail) {
        const chainId = Client_js_1.Client.getChainId();
        const apiKey = Client_js_1.Client.getApiKey();
        return await (0, block_api_js_1.getBlockByTag)(chainId, blockTag, txDetail, apiKey);
    }
}
exports.Block = Block;
