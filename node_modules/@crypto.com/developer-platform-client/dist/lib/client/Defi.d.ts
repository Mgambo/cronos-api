...
export declare class Defi {
     ...
     * console.log(tokens);
     */
    static getWhitelistedTokens(protocol: DefiProtocol): Promise<ApiResponse<WhitelistedToken[]>>;
    /**
     ...
     * console.log(farms);
     */
    static getAllFarms(protocol: DefiProtocol): Promise<ApiResponse<Farm[]>>;
    /**
     ...
     * console.log(farm);
     */
    static getFarmBySymbol(protocol: DefiProtocol, symbol: string): Promise<ApiResponse<Farm>>;
}
