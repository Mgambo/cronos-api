...
import { GetTransactionByHashData, GetTransactionsByAddressData, GetTransactionStatusData } from './interfaces/transaction.interfaces.js';
/**
...
export declare class Transaction {
     ...
     */
    static getTransactionsByAddress(address: string, startBlock: number, endBlock: number, session?: string, limit?: string): Promise<ApiResponse<GetTransactionsByAddressData>>;
    /**
     ...
     */
    static getTransactionByHash(txHash: string): Promise<ApiResponse<GetTransactionByHashData>>;
    /**
     ...
     * console.log(status);
     */
    static getTransactionStatus(txHash: string): Promise<ApiResponse<GetTransactionStatusData>>;
}
