...
export declare class Token {
     ...
     * console.log(balance);
     */
    static getNativeTokenBalance(address: string): Promise<ApiResponse<Balance>>;
    /**
     ...
     */
    static getERC20TokenBalance(address: string, contractAddress: string, blockHeight?: string): Promise<ApiResponse<TokenBalance>>;
    /**
